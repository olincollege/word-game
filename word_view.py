...
class View:
    ...
    def draw_intro(self):
        ...
        text = self.medium_font.render("Enter to Start", True, (0, 0, 0))
        self.screen.blit(
            text, ((self.screen_width / 2) - 150, self.screen_height / 1.8)
        )
    ...
    def draw_game_over(self):
        ...
        """
        self.screen.fill((255, 255, 255))
        text = self.medium_font.render("Hit Enter to Restart", True, (0, 0, 0))
        self.screen.blit(
            text, ((self.screen_width / 2) - 150, self.screen_height / 1.8)
        )
        text_2 = self.small_font.render(
            "Credits to Xethron on Github for the word list!", True, (0, 0, 0)
        )
        self.screen.blit(
            text_2,
            ((self.screen_width / 2) - 200, (self.screen_height / 2) + 100),
        )
        text_3 = self.big_font.render("Game Over!", True, (0, 0, 0))
        self.screen.blit(
            text_3,
            ((self.screen_width / 2) - 170, (self.screen_height / 2) - 150),
        )
        pygame.display.flip()
    ...
    def draw_score(self, score):
        ...
        self.screen.blit(
            ...
            (
                self.screen_width
                - (text_2.get_width() + text.get_width() + 10),
                self.screen_height - (text.get_height() + 10),
            ),
        )
    ...
    def draw_time_remaining(self, time_remaining):
        ...
        self.screen.blit(
            text, (self.screen_width - (text.get_width() + 50), 50)
        )
...
class Bubble:
    ...
    def __init__(self, index, letter):
        ...
        """
        x_index = index % 5
        self.x_position = (x_index * 100) + 100
        y_index = int(index / 5)
        self.y_position = (y_index * 100) + 100
